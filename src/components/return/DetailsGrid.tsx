...
import { ExpDateMmYyyyInput } from "@/components/return/ExpDateMmYyyyInput";
import { ItemCatalogAutocompleteCell } from "@/components/return/ItemCatalogAutocompleteCell";
import {
  getReturnFocusColumnAfter,
  RETURN_DETAIL_EDITABLE_COLUMNS,
  RETURN_DETAIL_GRID_COLUMNS,
  RETURN_DETAIL_GRID_LEGACY_WIDTH_KEY,
  RETURN_DETAIL_GRID_STORAGE_KEY,
} from "@/components/return/return-detail-grid-columns";
...
export function DetailsGrid({
  ...
  return (
    <MasterDetailGrid
      moduleKey="return"
      storageKey={RETURN_DETAIL_GRID_STORAGE_KEY}
      legacyWidthStorageKey={RETURN_DETAIL_GRID_LEGACY_WIDTH_KEY}
      columnConfig={RETURN_DETAIL_GRID_COLUMNS}
      columns={columns}
      data={rows}
      getRowId={(row) => row.clientRowId}
      editableColumns={RETURN_DETAIL_EDITABLE_COLUMNS}
      ...
      getFocusColumnAfter={getReturnFocusColumnAfter}
      isGridField={(target) =>

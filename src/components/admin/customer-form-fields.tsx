...
import { CustomerAccountChartCombobox } from "@/components/admin/customer-account-chart-combobox";
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        />
        <div className="space-y-2">
          <Label htmlFor="customer-contract-company">Contract Company</Label>
          <CustomerAccountChartCombobox
            value={values.custContractcompany}
            onValueChange={(value) => setField("custContractcompany", value)}
      ...
      <div className="space-y-2">
        <Label htmlFor="customer-contract-discount">Contract Company Discount</Label>
        <CustomerAccountChartCombobox
          value={values.custContractcompanydiscount}
          onValueChange={(value) => setField("custContractcompanydiscount", value)}
          placeholder="Select contract company discount"
        />
      </div>
